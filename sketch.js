...
function setup() {
  ...
  stone1 = new Stone(250,430,60,60);
   groundObj = new Ground(650,height,1300,20);
   tree1 = new Tree(1000,300,450,600);
   
   boy1 = new Boy(300,510,200,300);
   ...
   chainobj= new chain(stone1.body,{x:225,y:420})
	Engine.run(engine);
...
function keyPressed() {
 ...
 console.log(lmango.width/2+lstone.width/2)
  	if(distance<=lmango.width/2+lstone.width/2 || distance<=lmango.height/2+lstone.height/2)
    {
      //console.log(distance);
